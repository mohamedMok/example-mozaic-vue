<template>
  <div
    id="login"
    class="ml-flexy ml-flexy--space-around ml-flexy--items-center"
  >
    <div class="login">
      ...
      <div class="login-box">
        ...
        <div
          class="ml-flexy ml-flexy--space-around ml-flexy--items-center mu-mt-250"
        >
          <MButton label="Sign in" theme="primary" v-on:click="greet('toto')" />
        </div>
      </div>
    </div>
  </div>
